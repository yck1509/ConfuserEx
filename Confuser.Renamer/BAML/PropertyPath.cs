    ...
    class PropertyPath
    {
        ...
        static PropertyPathPart[] Parse(string path)
        {
            if (string.IsNullOrEmpty(path))
                return new PropertyPathPart[] { new PropertyPathPart(true, null, "") };
        ...
        PropertyPathPart[] parts;
        public PropertyPath(string path)
        {
            parts = Parse(path);
        }

        public PropertyPathPart[] Parts { get { return parts; } }
