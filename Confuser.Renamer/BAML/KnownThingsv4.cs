...
{
    class KnownThingsv4 : IKnownThings
    {
        Dictionary<int, AssemblyDef> assemblies;
        Dictionary<KnownTypes, TypeDef> types;
        Dictionary<KnownProperties, Tuple<KnownTypes, PropertyDef, TypeDef>> properties;

        public Func<KnownTypes, TypeDef> Types { get { return type => types[type]; } }
        public Func<KnownProperties, Tuple<KnownTypes, PropertyDef, TypeDef>> Properties { get { return property => properties[property]; } }
        public AssemblyDef FrameworkAssembly { get { return assemblies[0]; } }
