...
namespace Confuser.Core.Helpers
{
    ...
    public static class InjectHelper
    {
        ...
        class InjectContext : ImportResolver
        {
            ...
            public Importer Importer { get { return importer; } }
        }
        ...
        static void CopyMethodDef(MethodDef methodDef, InjectContext ctx)
        {
            ...
            foreach (var ca in methodDef.CustomAttributes)
                newMethodDef.CustomAttributes.Add(new CustomAttribute((ICustomAttributeType)ctx.Importer.Import((IMethod)ca.Constructor)));
